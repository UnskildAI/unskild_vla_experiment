"""Diffusion / flow-matching training pipeline."""
...
from src.training.trainers.diffusion import DiffusionTrainer, DiffusionTrainerConfig
from src.core.logging import get_logger


class DiffusionTrainingPipeline(BasePipeline):
    ...
    def run(self, **kwargs: Any) -> Any:
        ...
        trainer_config = DiffusionTrainerConfig(
        ...
        trainer = DiffusionTrainer(model=model, config=trainer_config)
