"""Vision -> Action policy training pipeline: dataset -> trainer -> checkpoint."""
...
from src.training.trainers.action import ActionTrainer, ActionTrainerConfig
from src.core.logging import get_logger


class ActionTrainingPipeline(BasePipeline):
    """Vision -> Action policy training pipeline: config -> dataloader + model + trainer -> train."""
    ...
    def run(self, **kwargs: Any) -> Any:
        ...
        trainer_config = ActionTrainerConfig(
        ...
        trainer = ActionTrainer(model=model, config=trainer_config)
